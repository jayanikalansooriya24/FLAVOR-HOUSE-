...
const Appetizers = () => {
  ...
  const appetizers = [
    { id: 1, name: "Caesar Salad", price: "Rs 350.00", type: "Vegetarian" },
    { id: 2, name: "Mozzarella Sticks", price: "Rs 650.00", type: "Vegetarian" },
    { id: 3, name: "Buffalo Wings", price: "Rs 800.00", type: "Vegetarian" },
    { id: 4, name: "Spring Rolls", price: "Rs 450.00", type: "Vegetarian" },
    { id: 5, name: "Garlic Bread", price: "Rs 350.00", type: "Vegetarian" },
    { id: 6, name: "Stuffed Mushrooms", price: "Rs 700.00", type: "Vegetarian" },
  ];
    ...
    <div className="appetizers-container">
      ...
      <div className="content-wrapper">
        ...
        <section className="filter-section">
          ...
          <p className="item-count">Showing 8 items</p>
        </section>
          ...
          {appetizers.map((item) => (
            <div key={item.id} className="product-card">
              <div className="product-image">
                <div className="img-placeholder">Food Image</div>
              </div>
