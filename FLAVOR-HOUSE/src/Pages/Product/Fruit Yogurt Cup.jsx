...
import wingsImg from "../../assets/Fruit Yogurt Cup.jpg"; 

const FruitYogurtCup = () => {
                    ...
                    <div className="modal-content">
                        ...
                        <div className="food-details-section">
                            <div className="food-header">
                                <h1>Fruit Yogurt Cup</h1>
                                <span className="food-price">Rs {(basePrice + sizePrice + addOnsPrice).toFixed(2)}</span>
                            </div>

                            <p className="food-description">
                                A traditional Sri Lankan dessert made with coconut milk, jaggery, and spices, steamed to perfection.
                            </p>
